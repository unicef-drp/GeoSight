...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gap_data', '0005_auto_20211118_0340'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('harvester_class', models.CharField(choices=[('gap_harvester.harveters.api_with_geography_and_date.APIWithGeographyAndDate', 'API With Geography And Date')], help_text='The type of harvester that will be used.Use class with full package.', max_length=256)),
                ...
                ('indicator', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='gap_data.indicator')),
            ],
        ),
        migrations.CreateModel(
            name='HarvesterLog',
