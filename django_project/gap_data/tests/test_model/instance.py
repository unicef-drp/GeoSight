...
class InstanceTest(TestCase):
    ...
    def test_scenario_levels(self):
        ...
        self.assertEquals(instance_1.scenario_levels[0].name,
                          'Scenario Level 1')
        self.assertEquals(instance_1.scenario_levels[1].name,
                          'Scenario Level 2')
        self.assertEquals(instance_1.scenario_levels[2].name,
                          'Scenario Level 3')
    ...
    def test_basemap_layers(self):
        ...
        BasemapLayerF(name='Basemap Instance 2 1', instance=instance_2,
                      show_on_map=False)
    ...
    def test_context_layers(self):
        ...
        ContextLayerF(name='Context Instance 2 1', instance=instance_2,
                      show_on_map=False)
