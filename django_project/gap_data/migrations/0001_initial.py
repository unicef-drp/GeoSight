# Generated by Django 3.2.13 on 2022-05-24 07:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, help_text='User who create the dashboard.', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('default_basemap_layer', models.ForeignKey(blank=True, help_text='If this is empty, the default will be latest basemap', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dashboard_default_basemap_layer', to='gap_data.basemaplayer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('SummaryWidget', 'SummaryWidget'), ('SummaryGroupWidget', 'SummaryGroupWidget')], default='SummaryWidget', max_length=256)),
                ...
                ('indicator', models.ForeignKey(blank=True, help_text='Use this layer when layer used is reference layer.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='gap_data.indicator')),
            ],
            options={
                'ordering': ('name',),
            },
