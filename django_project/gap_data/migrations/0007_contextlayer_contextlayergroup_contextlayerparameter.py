...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gap_data', '0006_auto_20211124_0258'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(default=0)),
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gap_data.contextlayergroup')),
