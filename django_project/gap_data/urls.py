...
from gap_data.api.download_file import DownloadSharepointFile, DownloadBackupsFile
...
from gap_data.api.indicators import IndicatorsValuesByGeometryDate, IndicatorsList
...
urlpatterns = [
    ...
    # Instances
    url(r'^instances/create', InstanceCreateView.as_view(), name='instance-management-create'),
    url(
