# Generated by Django 3.2.13 on 2022-07-06 02:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(default='#297CC2', help_text='Secondary color that used for example for button. ', max_length=16),
        ),
        migrations.AddField(
            model_name='sitepreferences',
            name='tertiary_color',
            field=models.CharField(default='#374EA2', help_text='Tertiary color that used for example for some special place. ', max_length=16),
        ),
